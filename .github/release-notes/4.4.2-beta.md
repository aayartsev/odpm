...
|----------|----------------|
| Debian/Ubuntu | download `odpm_4.4.2~beta-1_all.deb` or add the APT repo (**testing** suite) — [beta guide](https://aayartsev.github.io/odpm/4.4.2-beta/en/install/linux-deb/) · [stable 4.3.0](https://aayartsev.github.io/odpm/stable/en/install/linux-deb/) |
| Fedora 40+ | download `odpm-4.4.2-beta.fc*.noarch.rpm` or add the YUM repo (**testing**) — [beta guide](https://aayartsev.github.io/odpm/4.4.2-beta/en/install/fedora-rpm/) · [stable 4.3.0](https://aayartsev.github.io/odpm/stable/en/install/fedora-rpm/) |
...
- [Installing odpm (stable 4.3.0)](https://aayartsev.github.io/odpm/stable/en/install/) — recommended for production
- [Installing odpm (4.4.2-beta)](https://aayartsev.github.io/odpm/4.4.2-beta/en/install/) — matches this pre-release
- [Local dev from scratch (4.4.2-beta)](https://aayartsev.github.io/odpm/4.4.2-beta/en/getting-started/local-dev-from-scratch/) — demo project [odoo_demo_project](https://github.com/aayartsev/odoo_demo_project) (Odoo 19.0)
- [Extensions and extra services (4.4.2-beta)](https://aayartsev.github.io/odpm/4.4.2-beta/en/reference/plugins.md)
...
|-----------|----------------|
| Debian/Ubuntu | скачать `odpm_4.4.2~beta-1_all.deb` или подключить APT (**suite testing**) — [beta](https://aayartsev.github.io/odpm/4.4.2-beta/install/linux-deb/) · [stable 4.3.0](https://aayartsev.github.io/odpm/stable/install/linux-deb/) |
| Fedora 40+ | скачать `odpm-4.4.2-beta.fc*.noarch.rpm` или подключить YUM (**testing**) — [beta](https://aayartsev.github.io/odpm/4.4.2-beta/install/fedora-rpm/) · [stable 4.3.0](https://aayartsev.github.io/odpm/stable/install/fedora-rpm/) |
...
- [Установка odpm (stable 4.3.0)](https://aayartsev.github.io/odpm/stable/install/) — рекомендуется для production
- [Установка odpm (4.4.2-beta)](https://aayartsev.github.io/odpm/4.4.2-beta/install/) — соответствует этому pre-release
- [Локальная разработка с нуля (4.4.2-beta)](https://aayartsev.github.io/odpm/4.4.2-beta/getting-started/local-dev-from-scratch/) — демо-проект [odoo_demo_project](https://github.com/aayartsev/odoo_demo_project) (Odoo 19.0)
- [Расширения и дополнительные сервисы (4.4.2-beta)](https://aayartsev.github.io/odpm/4.4.2-beta/reference/plugins.md)
