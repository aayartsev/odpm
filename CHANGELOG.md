...
- **`odpm --plan`** — after configuration load, prints a table of prepare and runtime steps that would run on a normal invocation, without git pull, file writes, or `docker compose up`.
