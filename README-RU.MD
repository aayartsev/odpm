...
На компьютере должны быть установлены **Docker**, **git** и **odpm** (см. [установку](docs/install/README.md)).
...
Обзор платформ: **[Установка odpm (все платформы)](docs/install/README.md)**.
