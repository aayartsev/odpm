...
You need **Docker**, **git**, and **odpm** on the host (see [installation](docs/install/README.md)).
...
Platform overview: **[Installing odpm (all platforms)](docs/install/README.md)**.
