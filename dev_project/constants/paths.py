...
COMPOSE_TEMPLATE_MARKERS = [
    ...
    "{PYTHONWARNINGS_ENV_LINE}",
    "{COMPOSE_USER}",
    "{COMPOSE_SERVICE_FRAGMENTS}",
]
...
COMPOSE_FRAGMENTS_DIR_REL_PATH = os.path.join(
    PROJECT_SERVICE_DIRECTORY, "compose", "fragments"
)
COMPOSE_FRAGMENTS_SNAPSHOT_REL_PATH = os.path.join(
    COMPOSE_FRAGMENTS_DIR_REL_PATH, "services.snapshot.json"
)
