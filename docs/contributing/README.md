...
Этот раздел документации — для тех, кто **меняет исходный код** репозитория [odoo_dev_project](https://github.com/aayartsev/odoo_dev_project), а не для администраторов клиентских Odoo-проектов.
