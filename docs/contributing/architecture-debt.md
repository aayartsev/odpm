...
**Test baseline (2026-06-23):** `python3 -m unittest discover -s tests -q` → **1371** OK, 24 skipped.
...
**ADR backlog (4.6):** ADR-009 compose service patch **done** (D2); ADR-003 amendment **done** (D3); ADR-004 plugin 1.1 **done** (D4).
