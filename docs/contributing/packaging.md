...
|---------------------|---------|---------|
| `RELEASE_VERSION` | `4.4.3` | Git tag (`v4.4.3`), deb/rpm filenames, GitHub Release title, `odpm --version` |
| `LATEST_STABLE_RELEASE` | `4.4.3` | Recommended stable line for install docs and mike `stable` alias; bump **only** on stable tags |
