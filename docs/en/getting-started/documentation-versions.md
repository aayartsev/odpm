...
|---------|----------|--------------|
| **stable** (recommended) | production, new users | APT `stable` suite (**4.4.3**), [v4.4.3 release](https://github.com/aayartsev/odpm/releases/tag/v4.4.3) |
| **4.3** / **4.3.0** | staying on 4.3.x | 4.3.0 `.deb` / `.rpm` from Releases |
| **4.5.0-beta** | early adopters for 4.5 | APT/YUM **`testing`**, [v4.5.0-beta release](https://github.com/aayartsev/odpm/releases/tag/v4.5.0-beta) |
...
- Stable install hub: `/stable/install/` (alias **stable**, currently **4.4.3**)
