...
4.6 beta docs: [4.6.0-beta install guide](https://aayartsev.github.io/odpm/4.6.0-beta/en/install/fedora-rpm/) · archived 4.5: [4.5.0-beta](https://aayartsev.github.io/odpm/4.5.0-beta/en/install/fedora-rpm/) · archived 4.4: [4.4.3-beta](https://aayartsev.github.io/odpm/4.4.3-beta/en/install/fedora-rpm/) · [4.4.2-beta](https://aayartsev.github.io/odpm/4.4.2-beta/en/install/fedora-rpm/).
...
Download `odpm-*.rpm` from [GitHub Releases](https://github.com/aayartsev/odpm/releases) for tag `v4.6.0-beta` (testing), `v4.5.0` (stable), `v4.5.0-beta` (archived testing), `v4.4.3` (archived stable), `v4.4.3-beta` (archived testing), or `v4.4.2-beta` (archived beta), or build locally:
