...
Download `odpm_*_all.deb` from [GitHub Releases](https://github.com/aayartsev/odpm/releases) for the tag you need (`v4.4.3` — stable, `v4.5.0-beta` — testing, `v4.4.3-beta` — archived testing, `v4.4.2-beta` — archived beta), or build locally:
