...
Если вы только начинаете, имеет смысл пройти учебный репозиторий [odoo_demo_project](https://github.com/aayartsev/odoo_demo_project) параллельно с [локальной разработкой с нуля](local-dev-from-scratch.md).
...
2. Пройдите [локальную разработку с нуля](local-dev-from-scratch.md) или подключите учебный [odoo_demo_project](https://github.com/aayartsev/odoo_demo_project).
