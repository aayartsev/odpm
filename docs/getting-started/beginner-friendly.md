...
Если вы только начинаете, пройдите [локальную разработку с нуля](local-dev-from-scratch.md) со своим репозиторием или репозиторием вашей команды (в нём должен быть `odpm.json`). Для практики — публичный [odoo_demo_project](https://github.com/aayartsev/odoo_demo_project) (Odoo 19.0); другие major — [demo-проекты](../contributing/demo-projects.md).
