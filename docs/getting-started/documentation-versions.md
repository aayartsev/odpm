...
|--------|------|----------------|
| **stable** (рекомендуется) | production, новые пользователи | APT suite `stable` (**4.3.0**), [релиз v4.3.0](https://github.com/aayartsev/odpm/releases/tag/v4.3.0) |
...
- Стабильная установка: `/stable/install/` (alias **stable**, сейчас **4.3.0**)
