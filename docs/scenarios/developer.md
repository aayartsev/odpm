...
| **Base image** | По умолчанию профиль **full** (browser/Xvfb/IDE stack). Override: `ODPM_BASE_IMAGE_PROFILE` = `full` / `medium` / `ci` — см. [ADR-007](../contributing/adr-007-base-image-profiles.md). |
