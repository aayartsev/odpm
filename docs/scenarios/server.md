...
| **Base image** | По умолчанию профиль **medium**: wkhtmltopdf и build deps, без Chromium/Xvfb/IDE — см. [ADR-007](../contributing/adr-007-base-image-profiles.md). Override: `ODPM_BASE_IMAGE_PROFILE` = `full` / `medium` / `ci`. |
