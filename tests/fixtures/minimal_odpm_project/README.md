...
- **Full E2E** (`golden-path`, HTTP 200) requires a real initialized project: repo variable `ODPM_GOLDEN_PATH_ENABLED=true` and secret `ODPM_GOLDEN_PATH_PROJECT` — see [README.MD](../../../README.MD#docker-ci) CI matrix.
