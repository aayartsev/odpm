...
- **Full E2E** (`golden-path`, HTTP 200) runs on a self-hosted runner when `ODPM_GOLDEN_PATH_ENABLED=true` and secret `ODPM_GOLDEN_PATH_PROJECT` is set — see [contributing/ci.md](../../../docs/contributing/ci.md).
