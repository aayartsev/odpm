"""Contract tests for P4 stable 4.4.3 release prep."""
...
@unittest.skipUnless(
    constants.RELEASE_VERSION == "4.4.3",
    "P4 stable prep applies only when RELEASE_VERSION is 4.4.3",
)
class ReleaseStableP4Tests(unittest.TestCase):
    def test_release_version_is_stable_4_4_3(self):
    ...
    def test_stable_release_notes_exist_with_versioned_urls(self):
        notes = (PROJECT_ROOT / ".github" / "release-notes" / "4.4.3.md").read_text(
            encoding="utf-8"
        )
        ...
        self.assertIn("odpm_4.4.3-1_all.deb", notes)

    def test_install_readme_recommends_stable_4_4_3(self):
