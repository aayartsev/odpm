...
- [ ] создать пакеты deb и rpm и, возможно для mac
...
- [ ] TD-FEAT-08a: генератор run/debug конфигурации PyCharm из `debug-profile.json`
- [ ] TD-FEAT-08b: документация ручного attach для IDE без генератора (пути из профиля)
...
- [ ] проработать вариант использования ссылок на переменные окружения в файлах конфигурации (`odpm.json`, `.odpm/deps.lock.json` и др.)
